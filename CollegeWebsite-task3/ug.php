...
<head>
  ...
  <style>
    ...
    .logo {
      ...
      border: 2px solid #ffd700; text-align: center; line-height: 1.2;
    }
    ...
    .subtitle-bar {
      background: #fff; text-align: center; padding: 6px;
      font-style: italic; color: #444;
      border-bottom: 2px solid #6a3fa0; font-size: 14px;
    }
    .content { background: #fff; padding: 20px 30px; min-height: 300px; }
    .content h2 { color: #00008b; border-bottom: 2px solid #6a3fa0; padding-bottom: 6px; }
    .content ol { font-size: 15px; line-height: 1.9; }
    .nav-link {
      text-align: center; padding: 14px;
      background: #fff; border-top: 1px solid #ddd;
    }
    .nav-link a { color: #0645ad; text-decoration: none; }
...
<body>
  ...
  <!-- TEXT LINK back to home -->
  <div class="nav-link">
    <a href="/sanmathi/CollegeWebsite/index.php">⬅ Back to Home</a>
  </div>
